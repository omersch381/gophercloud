...
func TestCreate(t *testing.T) {
	...
	createOpts := tsigkeys.CreateOpts{
		...
		Secret:     "dO3oJQViWD3dLQum2XPgSsTxqKuMyPEDNVuxMicjBz0=",
		Scope:      "POOL",
...
func TestUpdate(t *testing.T) {
	...
	updateOpts := tsigkeys.UpdateOpts{
		...
		Secret: "newSecretKeyBase64Encoded123456789012345678901234=",
	}

	UpdatedTSIGKey := CreatedTSIGKey
	UpdatedTSIGKey.Name = "updatedsecondarykey"
	UpdatedTSIGKey.Secret = "newSecretKeyBase64Encoded123456789012345678901234="
